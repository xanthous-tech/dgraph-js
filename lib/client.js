        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        _e.trys.push([1, 3, , 8]);
                        _b = (_a = types.Payload).bind;
                        return [4, operation()];
                    case 2:
                        payload = new (_b.apply(_a, [void 0, _e.sent()]))();
                        return [3, 8];
                    case 3:
                        e_1 = _e.sent();
                    ...
                    case 4:
                        _e.sent();
                        _d = (_c = types.Payload).bind;
                        return [4, operation()];
                    case 5:
                        payload = new (_d.apply(_c, [void 0, _e.sent()]))();
                        return [3, 7];
                    case 6: throw e_1;
                    case 7: return [3, 8];
                    case 8:
...
function deleteEdges(mu, uid) {
    ...
    for (var _a = 0, predicates_1 = predicates; _a < predicates_1.length; _a++) {
        ...
        var nquad = new api_1.api.NQuad();
        nquad.subject = uid;
        nquad.predicate = predicate;
        var ov = new api_1.api.Value();
