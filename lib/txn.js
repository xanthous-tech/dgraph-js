...
var Txn = (function () {
    function Txn(dc, txnOpts) {
        ...
        this.dc = dc;
        this.ctx = new api_1.api.TxnContext();
    ...
    Txn.prototype.doRequest = function (req, metadata, options) {
        return __awaiter(this, void 0, void 0, function () {
            var resp, c, operation, _a, _b, e_1, _c, _d, e_2;
            var _this = this;
                ...
                switch (_e.label) {
                    case 0:
                        if (this.finished) {
                            ...
                            this.dc.debug("Do request (ERR_FINISHED):\nmutation = " + util_1.stringifyMessage(req.mutations[0]));
                            throw errors_1.ERR_FINISHED;
                        }
                    ...
                    case 1:
                        _e.trys.push([1, 3, , 11]);
                        _b = (_a = types.Response).bind;
                        return [4, operation()];
                    case 2:
                        resp = new (_b.apply(_a, [void 0, _e.sent()]))();
                        return [3, 11];
                    case 3:
                        e_1 = _e.sent();
                    ...
                    case 4:
                        _e.sent();
                        _d = (_c = types.Response).bind;
                        return [4, operation()];
                    case 5:
                        resp = new (_d.apply(_c, [void 0, _e.sent()]))();
                        return [3, 10];
                    case 6:
                        _e.trys.push([6, 8, , 9]);
    ...
    Txn.prototype.mergeContext = function (src) {
        ...
        if (src.keys && src.keys.length > 0) {
            ...
            for (var _i = 0, _a = src.keys; _i < _a.length; _i++) {
                var key = _a[_i];
